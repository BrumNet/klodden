...
class OrderInfo extends StatelessWidget {
  ...
  OrderInfo(this.price, this.minDeposit, this.material, this.color, this.style,
      this.gender, this.view);
                    ...
                    view == true
                        ? ElevatedButton(
                            onPressed: () {
                              ...
                              connectCatalog(price, minDeposit, material, color,
                                  style, gender);
                              showDialog(
                                  context: context,
                                  builder: (context) {
